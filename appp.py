...
st.set_page_config(page_title="Gemma Model Document Q&A")
...
with st.sidebar:
    ...
    doc_embedding_btn = st.button("📚 Embed Documents")
...
def vector_embedding(google_api_key):
...
# --- Document Embedding ---
if doc_embedding_btn:
    if not groq_api_key or not google_api_key:
        st.error("Please enter both GROQ and Google API keys in the sidebar.")
    else:
        with st.spinner("Processing and embedding documents..."):
            vector_embedding(google_api_key)
